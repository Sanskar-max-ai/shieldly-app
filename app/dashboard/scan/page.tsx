...
const WEB_SCAN_STEPS = [
  ...
  "[NMAP] Initializing stealth port discovery...",
  "[NMAP] Probing Top 20 common service ports...",
  "[NMAP] Port 80/443 (HTTP/S) identified...",
  "Analyzing SSL/TLS handshake protocols...",
  "[NUCLEI] Loading vulnerability signature templates...",
  "[NUCLEI] Fingerprinting tech-stack versions...",
