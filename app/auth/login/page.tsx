    ...
    <div className="hero-bg grid-bg min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--shield-text)' }}>Sign in to your account</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: 'var(--shield-text)' }}>Email</label>
            ...
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: 'var(--shield-text)' }}>Password</label>
          ...
          <div className="mt-4 pt-4" style={{ borderTop: '1px solid var(--shield-border)' }}>
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--shield-text)' }}>
          ...
          <Link href="/auth/signup" className="font-semibold" style={{ color: 'var(--shield-green)' }}>
            Start free →
          </Link>
        </p>
      </div>
